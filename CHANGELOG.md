...
- Fixed a bug that caused logo-ls not to resolve symlinks correctly when listing a specific file with `ls -al [file-name]`.
...
- Fixed bug when linking version during build, that caused logo-ls to print empty version

## logo-ls [1.6.1]

### Features

- CI pushes to the AUR repository
