...
var Icon_FileName = map[string]*Icon_Info{
	...
	"nuxt.d.ts":                           Icon_Set["nuxt"],
	".nuxtrc":                             Icon_Set["nuxt"],
	...
	"pnpm-lock.yaml":                      Icon_Set["nodejs"],
	...
	"eslint.config.js":                    Icon_Set["eslint"],
	"eslint.config.ts":                    Icon_Set["eslint"],
	"eslint.config.cjs":                   Icon_Set["eslint"],
	"eslint.config.mjs":                   Icon_Set["eslint"],
	"eslint.config.d.mts":                 Icon_Set["eslint"],
	...
	"tailwind.config.ts":                  Icon_Set["tailwindcss"],
	"tailwind.config.cjs":                 Icon_Set["tailwindcss"],
	"tailwind.config.mjs":                 Icon_Set["tailwindcss"],
	...
	"commitlint.config.ts":                Icon_Set["commitlint"],
	...
	"svelte.config.js":                    Icon_Set["svelte"],
	"svelte.config.ts":                    Icon_Set["svelte"],
	"i18n.config.js":                      Icon_Set["i18n"],
	"i18n.config.ts":                      Icon_Set["i18n"],
	"i18n.options.mjs":                    Icon_Set["i18n"],
	"tsconfig.json":                       Icon_Set["typescript-def"],
	"tsconfig.server.json":                Icon_Set["typescript-def"],
	...
	".zshrc":                              Icon_Set["console"],
	".zshenv":                             Icon_Set["console"],
	".zprofile":                           Icon_Set["console"],
	".zlogin":                             Icon_Set["console"],
	".zlogout":                            Icon_Set["console"],
	".zhistory":                           Icon_Set["console"],
	".zsh_aliases":                        Icon_Set["console"],
	".zsh_history":                        Icon_Set["console"],
	// ".vfl":                                Icon_Set["vfl"],
	// ".kl":                                 Icon_Set["kl"],
